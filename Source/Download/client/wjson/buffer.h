...
extern void buffer_putc (struct buffer *b, unsigned char c);
/* Add a NUL-terminated string to the end of the buffer. */
extern void buffer_putstr (struct buffer *b, const char *c);
...
void buffer_join( struct buffer *b, struct buffer *p);
