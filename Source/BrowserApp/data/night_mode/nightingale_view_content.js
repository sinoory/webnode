...
function a()
{
                 ...
                 function h()
                 {
                   var j=Math.max.apply(null,c.map(c("body > *"),function(l,k){return parseInt(c(l).css("z-index"))||1}));
                   var i=Math.max.apply(null,c.map(c("body > *"),function(l,k){if(c(l).css("position")=="relative"){return parseInt(c(l).css("z-index"))||1}}));
                   j=(j+i+2>=2147483647)?(j+i+2):2147483647;
                   return j
                 }

                 c("#__nightingale_view_cover").remove();
                 d=document.createElement("div");
                 d.id="__nightingale_view_cover";
                 d.setAttribute("style","width: 100%; height: 100%; position: fixed !important;left: 0 !important;bottom: 0 !important;-webkit-transition: -webkit-transform 10s ease-in-out;overflow: hidden !important;background: #000000 !important;pointer-events: none !important;");
