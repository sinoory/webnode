...
#include "HTMLViewSourceDocument.h" //Only for cdos browser
#include "Image.h"
...
RefPtr<Document> DOMImplementation::createDocument(const String& type, Frame* frame, const URL& url,bool inViewSourceMode)
{
    if (inViewSourceMode)
